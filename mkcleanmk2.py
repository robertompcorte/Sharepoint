...
def merge_duplicate_titles(markdown_text):
    # Limpiar caracteres especiales del texto
    markdown_text = clean_special_characters(markdown_text)
    ...
    for block in blocks:
        ...
        if title in title_content_map:
            title_content_map[title] += ' ' + content  # Concatenar contenido con espacio
        else:
